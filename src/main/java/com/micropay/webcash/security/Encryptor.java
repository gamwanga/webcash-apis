...
public class Encryptor {
     ...
     */
    private static final String DEFAULT_NEW_PASS_PHRASE = "$%#@#@224343445glyde@greyboxconsult.com";


    protected Encryptor() throws Exception {
        super();
    ...
    public static void main(String args[]) throws Exception {
        Encryptor decrypter = new Encryptor();
